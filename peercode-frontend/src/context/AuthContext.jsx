...
export function AuthProvider({ children }) {
 ...
 const exp = parseJwtExp(token)
 if (exp) {
 const refreshAt = exp - Date.now() - 2 * 60 * 1000
 if (refreshAt > 0) {
 ...
 const value = useMemo(
 () => ({ user, setUser, accessToken, setAccessToken, isLoading, login, register, logout, refreshToken, verifyOTP, resendOTP, showExpiryWarning, renewSession, dismissExpiryAndLogout }),
 [user, accessToken, isLoading, login, register, logout, refreshToken, verifyOTP, resendOTP, showExpiryWarning, renewSession, dismissExpiryAndLogout]
 )
