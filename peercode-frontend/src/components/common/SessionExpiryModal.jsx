...
export default function SessionExpiryModal() {
  ...
  return (
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      <div className="relative bg-gray-900 border border-gray-700 rounded-2xl shadow-2xl p-6 max-w-sm w-full">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h2 className="text-base font-bold text-gray-100">Session Expiring Soon</h2>
        </div>
