...
export default function PlaybackTimeline({ snapshots = [], currentIndex, onChange }) {
 ...
 <div
 className="relative h-2 bg-bg-overlay rounded-full cursor-pointer"
 onClick={handleScrub}
 >
 <div
 ...
 />
 <div
 className="absolute top-1/2 -translate-y-1/2 w-4 h-4 bg-indigo-400 rounded-full shadow-lg border-2 border-border-default cursor-grab"
 ...
 speed === s ? 'bg-indigo-600 text-white' : 'text-text-muted hover:text-text-primary'
 }`}
 >
 {s}x
 </button>
