...
export default function MatchingQueue() {
 ...
 <div>
 <h3 className="text-lg font-bold text-text-primary">Match Found!</h3>
 <p className="text-text-muted text-sm mt-1">Redirecting to room...</p>
 </div>
 </div>
 )
 }
 ...
 <div>
 <h3 className="text-lg font-bold text-text-primary">No partner found</h3>
 <p className="text-text-muted text-sm mt-1">Could not find a match within 60 seconds</p>
 </div>
 ...
 className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold bg-bg-elevated hover:bg-bg-overlay text-text-primary border border-border-strong transition-colors"
 >
 ...
 <div>
 <h3 className="text-lg font-bold text-text-primary">Finding a Partner...</h3>
 <p className="text-text-muted text-sm mt-1">
 {queuePosition ? `Queue position: #${queuePosition}` : 'Searching...'}
 </p>
 <p className="text-text-muted text-xs mt-1">Role: {role} • Topic: {topic}</p>
 </div>
 <div className="w-full max-w-xs bg-bg-elevated rounded-full h-1.5">
 <div
 className="bg-indigo-500 h-1.5 rounded-full transition-all duration-1000"
 style={{ width: `${((60 - countdown) / 60) * 100}%` }}
 />
 </div>
 <p className="text-sm text-text-muted font-mono">{countdown}s remaining</p>
 <div className="flex gap-2 mt-2">
 <Loader2 className="w-4 h-4 text-indigo-400 animate-spin" />
 <span className="text-sm text-text-muted">This may take a moment</span>
 </div>
 <button
 onClick={handleLeave}
 className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium bg-bg-elevated hover:bg-bg-overlay text-text-muted hover:text-text-primary border border-border-strong transition-colors"
 >
 <X className="w-4 h-4" />
 Cancel
 </button>
 ...
 <h3 className="text-base font-bold text-text-primary">Quick Match</h3>
 </div>
 <p className="text-text-muted text-xs">Get paired with another developer instantly</p>
 </div>

 <div>
 <label htmlFor="role-group" className="text-xs font-medium text-text-muted block mb-2">Your Role</label>
 ...
 : 'bg-bg-elevated border-border-strong text-text-muted hover:text-text-primary hover:border-border-strong'
 }`}
 >
 {r.label}
 </button>
 ...
 <div>
 <label htmlFor="topic-group" className="text-xs font-medium text-text-muted block mb-2">Topic</label>
 ...
 topic === t
 ? 'bg-indigo-600 border-indigo-500 text-white'
 : 'bg-bg-elevated border-border-strong text-text-muted hover:text-text-primary'
 }`}
 >
 {t}
 </button>
