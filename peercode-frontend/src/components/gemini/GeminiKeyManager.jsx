...
export default function GeminiKeyManager() {
 ...
 <div>
 <h3 className="font-semibold text-text-primary">Gemini API Key</h3>
 <p className="text-xs text-text-muted">Use your personal key for unlimited AI hints</p>
 </div>
 ...
 className="w-full bg-bg-surface border border-border-strong text-text-primary rounded-xl px-4 py-2.5 pr-12 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-500 placeholder-gray-400 dark:placeholder-text-muted transition-colors"
 ...
 <div className="flex items-start gap-2 p-3 bg-bg-elevated/50 rounded-xl text-xs text-text-muted">
 <Key className="w-3.5 h-3.5 text-text-muted flex-shrink-0 mt-0.5" />
 <div>
