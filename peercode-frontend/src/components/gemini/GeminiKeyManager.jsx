  ...
  return (
    <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 space-y-4">
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 bg-indigo-900/40 rounded-xl flex items-center justify-center border border-indigo-800/50">
          <Key className="w-5 h-5 text-indigo-400" />
        </div>
        <div>
          <h3 className="font-semibold text-gray-100">Gemini API Key</h3>
          <p className="text-xs text-gray-500">Use your personal key for unlimited AI hints</p>
        </div>
        <div className="ml-auto">
          {hasPersonalKey ? (
            <span className="flex items-center gap-1.5 text-xs bg-green-900/40 text-green-400 px-3 py-1.5 rounded-full border border-green-800/50">
              <ShieldCheck className="w-3.5 h-3.5" />
              Active - bypassing shared pool
            </span>
          ) : (
            <span className="flex items-center gap-1.5 text-xs bg-blue-900/40 text-blue-400 px-3 py-1.5 rounded-full border border-blue-800/50">
        ...
        <div className="flex gap-2">
          <div className="relative flex-1">
            <input
              ...
              className="w-full bg-gray-800 border border-gray-700 text-gray-100 rounded-xl px-4 py-2.5 pr-12 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 placeholder-gray-600 transition-colors"
          ...
          {hasPersonalKey && (
            <button
              ...
              disabled={validating}
              className="px-3 py-2.5 rounded-xl text-sm font-semibold bg-red-900/30 hover:bg-red-900/50 text-red-400 border border-red-800/50 transition-colors disabled:opacity-50"
      ...
      <div className="flex items-start gap-2 p-3 bg-gray-800/50 rounded-xl text-xs text-gray-500">
        <Key className="w-3.5 h-3.5 text-gray-600 flex-shrink-0 mt-0.5" />
        <div>
          Get a free Gemini API key from{' '}
          <a href="https://aistudio.google.com" target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:text-indigo-300 inline-flex items-center gap-0.5">
            aistudio.google.com
