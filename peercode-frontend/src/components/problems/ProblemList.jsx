...
export default function ProblemList({ filters = {}, onPractice }) {
 ...
 <div key={problem._id || problem.id} className="bg-bg-surface border border-border-default rounded-xl p-5 hover:border-border-strong transition-colors flex flex-col gap-3">
 ...
 <span key={c} className="inline-flex items-center gap-1 text-xs bg-bg-elevated text-text-muted px-2 py-0.5 rounded border border-border-strong">
 ...
 <Link
 to={`/problems/${problem.slug}`}
 className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium bg-bg-elevated hover:bg-bg-overlay text-text-secondary hover:text-white border border-border-strong transition-colors"
 >
