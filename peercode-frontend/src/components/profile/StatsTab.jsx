...
export default function StatsTab({ profile }) {
 ...
 {[...Array(3)].map((_, i) => (
 <div key={i} className="h-32 bg-bg-elevated/50 rounded-xl animate-pulse" />
 ))}
 </div>
 )
 }
 ...
 <div className="bg-bg-surface border border-border-default rounded-xl p-4">
 <h3 className="text-sm font-semibold text-text-secondary mb-4">ELO History</h3>
 <EloHistoryChart data={eloHistory} />
 </div>

 <div className="bg-bg-surface border border-border-default rounded-xl p-4">
 <h3 className="text-sm font-semibold text-text-secondary mb-4">Tag Breakdown</h3>
 <TagRadarChart solvedByTag={s.solvedByTag} />
 </div>

 <div className="bg-bg-surface border border-border-default rounded-xl p-4">
 <h3 className="text-sm font-semibold text-text-secondary mb-4">Recent Matches</h3>
