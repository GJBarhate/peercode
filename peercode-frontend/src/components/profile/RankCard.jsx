...
export const RankCard = memo(function RankCard({ username, elo = 1200, rank, percentile, wins = 0, totalMatches = 0, winRate = 0 }) {
 ...
 <div className="absolute inset-0 bg-bg-base/20 dark:bg-black/20" />
 ...
 <div className="mb-1">
 <div className={`text-sm font-bold text-white/90 bg-bg-surface/20 px-2.5 py-0.5 rounded-full`}>{title}</div>
 </div>
 </div>
