      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-2xl transition-all">
                {step === 'loading' && (
                  ...
                  <>
                    ...
                    <div className="px-6 py-4 space-y-4">
                      <div className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border border-indigo-200/50 dark:border-indigo-700/30">
                        ...
                        <div>
                          <p className="font-semibold text-gray-900 dark:text-gray-100">{PLAN_NAMES[info.plan]}</p>
                          <p className="text-xs text-gray-500 dark:text-gray-400">₹{info.planPrice}/month</p>
                        </div>
                      </div>

                      <div className="space-y-3">
                        <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Refund Summary</p>

                        <div className="space-y-2.5">
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-600 dark:text-gray-400">Plan Price</span>
                            <span className="font-semibold text-gray-900 dark:text-gray-100">₹{info.planPrice}</span>
                          </div>
                          ...
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-600 dark:text-gray-400">Amount Consumed</span>
                    ...
                    <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-800 flex gap-3 justify-end">
                      <button
                        onClick={onClose}
                        disabled={cancelling}
                        className="px-5 py-2.5 rounded-xl text-sm font-semibold bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                      >
                        Keep Plan
                      </button>
                      <button
                ...
                {step === 'success' && (
                  <div className="px-6 py-10 text-center space-y-4">
                    ...
                    <p className="text-sm text-gray-500">
                      Your {PLAN_NAMES[info?.plan]} plan has been cancelled. Refund of <strong className="text-gray-900 dark:text-gray-100">₹{info?.refundAmount}</strong> will be sent within 24 hours.
                    </p>
                ...
                {step === 'error' && (
                  <div className="px-6 py-10 text-center space-y-4">
                    ...
                    <p className="text-sm text-gray-500">{errorMsg || 'Please try again later.'}</p>
                    <button onClick={onClose} className="px-5 py-2.5 rounded-xl text-sm font-semibold bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 transition-colors">
                      Close
                    </button>
                  </div>
                )}
