...
export default function ProblemOfTheDay() {
 ...
 return (
 <div className="bg-bg-surface/60 border border-white/[0.06] rounded-2xl p-6 backdrop-blur-sm">
 <div className="flex items-center gap-2 mb-4">
 <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center">
 <Flame className="w-4 h-4 text-white" />
 </div>
 <h3 className="font-bold text-text-primary">Problem of the Day</h3>
 </div>
 <div className="flex items-start justify-between gap-4">
 <div className="flex-1 min-w-0">
 <h4 className="font-semibold text-text-primary text-lg mb-2 truncate">{problem.title}</h4>
 ...
 {problem.description && (
 <p className="text-sm text-text-muted line-clamp-2">{problem.description}</p>
 )}
 </div>
 <Link
