...
export default function ProfilePage() {
 ...
 <p className="text-xs text-text-muted">You will need a password to sign in.</p>
 ...
 className="px-3 py-1 rounded-lg text-xs font-medium bg-bg-overlay text-text-secondary hover:bg-bg-hover transition-colors"
 >
 Cancel
 </button>
 </div>
 ...
 <div className="max-w-6xl mx-auto px-4 pt-6 pb-16 space-y-6">
 ...
 activeTab === key ? 'bg-indigo-600 text-white' : 'text-text-muted hover:text-text-primary'
 }`}
 >
 ...
 {activeTab === 'settings' && (<>
 <section className="lg:col-span-2 bg-bg-surface border border-border-default rounded-lg p-6">
 <div className="flex flex-col sm:flex-row sm:items-center gap-5 mb-6">
 <div className="w-16 h-16 bg-indigo-600 rounded-lg flex items-center justify-center text-2xl font-bold text-text-primary dark:text-white">
 ...
 onClick={handleSave}
 disabled={isSaving}
 className="mt-4 flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-semibold bg-indigo-600 hover:bg-indigo-500 text-text-primary dark:text-white transition-colors disabled:opacity-50"
 >
 ...
 <section className="bg-bg-surface border border-border-default rounded-lg p-6">
 ...
 className="flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-semibold bg-indigo-600 hover:bg-indigo-500 text-text-primary dark:text-white transition-colors disabled:opacity-50"
 >
 ...
 <h2 className="font-semibold text-text-primary">Streak</h2>
 </div>
 ...
 <p className="text-4xl font-black text-text-primary">{longestStreak}</p>
 <p className="text-xs text-text-muted">days</p>
 </div>
 <div className="bg-bg-base border border-border-default rounded-lg p-4">
 ...
 <h2 className="font-semibold text-text-primary">Activity Calendar</h2>
 </div>
 ...
 <p className="mt-3 text-xs text-text-muted">Complete sessions on consecutive days to grow your streak.</p>
 </section>
 ...
 <div>
 <div className="flex justify-between text-xs mb-1">
 <span className="text-text-muted">Analyzes</span>
 <span className="text-text-primary font-semibold">
 ...
 <Link to="/subscription" className="flex items-center justify-center w-full px-4 py-2.5 rounded-lg bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-text-primary dark:text-white font-semibold transition-all">
 Manage Subscription
 </Link>
 {subscription?.plan !== 'free' && (
 <Link to="/subscription" className="flex items-center justify-center w-full px-4 py-2.5 rounded-lg border border-border-strong hover:bg-bg-elevated text-text-secondary font-semibold transition-all">
 Cancel / Change Plan
 </Link>
 )}
 </div>
 ...
 {subscription?.plan === 'free' && (
 <div className="rounded-lg border border-border-default bg-gradient-to-br from-amber-500/10 to-orange-600/10 p-5">
 ...
 <p className="text-sm text-text-muted mb-4">Unlock more AI hints, priority support & advanced analytics</p>
 <Link to="/subscription" className="flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-lg bg-amber-500 hover:bg-amber-600 text-text-primary dark:text-white font-semibold transition-colors">
 Upgrade Now
 </Link>
 </div>
 )}
 ...
 <h2 className="font-semibold text-text-primary">Google Account</h2>
 </div>
 {profile?.googleId ? (
 ...
 <div>
 <p className="font-medium text-text-primary">Linked to Google</p>
 ...
 <div>
 <p className="font-medium text-text-primary">Link Google Account</p>
 <p className="text-sm text-text-muted">Sign in with Google for faster access</p>
 </div>
 </div>
 <button
 ...
 : 'bg-bg-base border-border-default opacity-70'
 }`}
 >
 <Icon className={`w-5 h-5 mb-3 ${earned ? 'text-indigo-600 dark:text-indigo-300' : 'text-text-muted'}`} />
 <p className="text-sm font-semibold text-text-primary">{achievement.label}</p>
 <p className="text-xs text-text-muted mt-1">{achievement.desc}</p>
 </div>
 )
 })}
 </div>
