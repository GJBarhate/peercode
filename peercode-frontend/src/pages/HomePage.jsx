...
export default function HomePage() {
 ...
 <h1 className="text-5xl lg:text-6xl font-black text-text-primary leading-tight mb-6">
 <TypeAnimation
 sequence={[
 'Solve Problems',
 2000,
 ...
 <Link
 to="/problems"
 className="flex items-center gap-2 px-6 py-3 rounded-xl font-semibold text-text-primary bg-white/[0.05] hover:bg-white/[0.09] border border-white/[0.1] hover:border-white/[0.18] transition-all duration-300 hover:-translate-y-0.5"
 >
 Solve Problems Solo
 </Link>
 </div>
 ...
 {!user ? (
 <div className="bg-bg-surface/80 border border-white/[0.08] rounded-2xl p-6 shadow-2xl shadow-black/40 backdrop-blur-md">
 ...
 isLogin === key ? 'bg-white/[0.1] text-text-primary shadow-sm' : 'text-text-muted hover:text-text-secondary'
 }`}
 >
 {label}
 </button>
 ...
 disabled={isLoading}
 className="w-full flex items-center justify-center gap-2.5 px-4 py-3 rounded-xl text-sm font-medium bg-white/[0.05] hover:bg-white/[0.09] border border-white/[0.1] hover:border-white/[0.18] text-text-primary transition-all duration-300 disabled:opacity-50"
 >
 ...
 <span className="px-2 bg-bg-surface text-text-muted">Or continue with email</span>
 </div>
 </div>
 {!isLogin && (
 <div>
 ...
 className="absolute right-3 top-1/2 -translate-y-1/2 text-text-muted hover:text-text-secondary transition-all duration-300"
 ...
 />
 <p className="text-xs text-text-muted mt-1">Check your email for the verification code</p>
 </div>
 <button
 ...
 <div>
 <HeroIllustration />
 <div className="bg-bg-surface/80 border border-white/[0.08] rounded-2xl p-4 mt-4 backdrop-blur-md">
 <p className="text-text-muted text-sm mb-3">Welcome back, <span className="text-indigo-400 font-semibold">{user.username}</span>!</p>
 ...
 <Link to="/problems" className="flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-semibold bg-white/[0.05] hover:bg-white/[0.09] text-text-primary border border-white/[0.1] hover:border-white/[0.18] transition-all duration-300">
 Problems
 </Link>
 </div>
 </div>
 ...
 <p className="text-text-muted max-w-md mx-auto">Three steps to sharpen your skills and land your next role</p>
 </div>
 ...
 <h3 className="font-semibold text-text-primary mb-1.5 text-lg">{title}</h3>
 ...
 <div className="bg-bg-surface/60 border border-white/[0.06] rounded-2xl overflow-hidden backdrop-blur-sm">
 <div className="px-6 py-5 border-b border-white/[0.06]">
 <div className="flex items-center gap-2">
 <Users className="w-5 h-5 text-indigo-400" />
 <h2 className="text-lg font-bold text-text-primary">Find a Partner Right Now</h2>
 </div>
 <p className="text-text-muted text-sm mt-1">Get instantly matched with another developer for a practice session</p>
 </div>
 <MatchingQueue />
 </div>
 </div>
 ...
 <p className="text-text-muted">Solve problems solo or with a partner — real-time collaboration, AI feedback, and structured learning tracks</p>
 </div>
 ...
 <div className="text-center mb-12">
 <h2 className="text-3xl font-bold text-text-primary mb-3">Loved by developers</h2>
 <p className="text-text-muted">Join thousands who've already leveled up their interview game</p>
 </div>
 ...
 <p className="text-text-secondary text-sm leading-relaxed mb-5">"{quote}"</p>
