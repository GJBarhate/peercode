...
import { Code2, Video, Users, Brain, BarChart3, ArrowRight, X, Eye, EyeOff } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-950">
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7">
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  to="/problems"
                  className="flex items-center gap-2 px-6 py-3 rounded-xl font-semibold text-white bg-indigo-600 hover:bg-indigo-500 transition-colors"
                >
                  Start Practice
            ...
            <div className="lg:col-span-5 space-y-4">
              {!user ? (
                    ...
                    {[
                      ...
                      <button
                        ...
                        className={`flex-1 py-2 rounded-lg text-sm font-medium transition-colors ${
                          isLogin === key ? 'bg-gray-700 text-gray-100' : 'text-gray-500 hover:text-gray-300'
                        }`}
                      >
                        {label}
                      </button>
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
                  <p className="text-gray-400 text-sm mb-4">Welcome back, <span className="text-indigo-400 font-semibold">{user.username}</span>!</p>
                  <div className="grid grid-cols-2 gap-3">
                    <Link to="/dashboard" className="flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-semibold bg-indigo-600 hover:bg-indigo-500 text-white transition-colors">
                      Dashboard
                    </Link>
                    <Link to="/problems" className="flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-semibold bg-gray-800 hover:bg-gray-700 text-gray-200 border border-gray-700 transition-colors">
                      Problems
                    </Link>
                  </div>
                </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-100 mb-3">Everything you need to ace interviews</h2>
          <p className="text-gray-400">Professional-grade tools designed for serious interview prep</p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          {features.map(({ icon: Icon, title, desc, color, bg }) => (
            <div key={title} className="bg-gray-900 border border-gray-800 rounded-2xl p-6 hover:shadow-lg hover:shadow-indigo-500/10 hover:border-indigo-500/30 transition-all duration-300">
