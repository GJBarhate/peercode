    ...
    <div className="min-h-screen bg-gray-950 text-gray-100">
      ...
      <div className="max-w-lg mx-auto px-4 pt-24 pb-16">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-black text-gray-100">Private Room</h1>
            <p className="text-sm text-gray-500">Practice with a specific friend</p>
          </div>
        </div>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 space-y-5">
            {!createdRoom ? (
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    min={5}
                    max={120}
                    className="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-2.5 text-sm text-gray-100 placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                  />
                </div>

                <div className="flex items-center justify-between p-3 bg-gray-800 rounded-xl">
                  <div>
                    <div className="text-sm font-medium text-gray-200">Ranked Match</div>
                    <div className="text-xs text-gray-500">ELO affected by result</div>
                  </div>
                  <button
                    onClick={() => setIsRanked(v => !v)}
                    className={`relative w-11 h-6 rounded-full transition-colors ${isRanked ? 'bg-indigo-600' : 'bg-gray-700'}`}
                  >
                    <div className={`absolute top-1 left-1 w-4 h-4 rounded-full bg-white transition-transform ${isRanked ? 'translate-x-5' : 'translate-x-0'}`} />
                  </button>
                </div>
              ...
              <div className="space-y-4 text-center">
                ...
                <h2 className="text-xl font-bold text-gray-100">Room Created!</h2>
                <p className="text-gray-400 text-sm">Share this invite code with your friend</p>
                ...
                <button
                  onClick={handleCopy}
                  className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-semibold bg-gray-800 hover:bg-gray-700 border border-gray-700 text-gray-200 transition-colors"
                >
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 space-y-5">
            <div>
              ...
              <input
                ...
                placeholder="ABCDEF"
                maxLength={6}
                className="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-3 text-2xl font-black tracking-[0.3em] text-center text-indigo-400 placeholder-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
